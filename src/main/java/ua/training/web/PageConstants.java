...
public interface PageConstants {
    String CRUISE_COMPANY_PATTERN = ".*/cruise-company/";
    String PAGE_404_JSP = "/WEB-INF/404.jsp";
    String ADD_TICKET_JSP = "/WEB-INF/admin/add-ticket.jsp";
    String ADMIN_ADD_TICKET_JSP = "/WEB-INF/admin/add-ticket.jsp";
    String ALL_PASSENGERS_JSP = "/WEB-INF/admin/all-passengers.jsp";
    ...
    String ADMIN_MAIN_JSP = "/WEB-INF/admin/main.jsp";
